---
title: >
  How I create presentations in HTML
date: 2025-03-24
...
titleImage: ./alex-litvin-MAYsdoYpGuk-unsplash.avif
...
<BlogImg
  filename="slides-region-viewer.avif"
...
- To minimize file size, I convert all images to the AVIF format with this command: `bunx avif --input "./imgs/*.{jpg,png}" --quality 80 --effort 8 --overwrite && rm -r ./imgs/*.png || true && rm -r ./imgs/*.jpg || true` (requires Bun).
