...
As you can see in rows 12, 13, and 18 these fonts cause two connections to different servers. The interesting part is the one I highlighted in red borders. This is exactly the cost of an additional connection consisting of a DNS lookup, the connection itself, and establishing an SSL encrypted connection.
