...
So in this case I still need to add data attributes with IDs to the links and manually listen for the events as I need the to pass the ID to set a page item.
